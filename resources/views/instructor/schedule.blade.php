<x-app-layout>
    <x-slot name="header">
      <h2 class="text-xl font-semibold leading-tight text-gray-800">Schedule a Class</h2>
    </x-slot>
            ...
            <form action="{{ route('schedule.store') }}" method="post" class="max-w-lg">
              ...
              <div class="space-y-6">
                <div>
                  ...
                  <select name="class_type_id" class="mt-2 block w-full border-gray-300 focus:border-gray-500 focus:ring-0">
                ...
                <div class="flex gap-6">
                  ...
                  <div class="flex-1">
                    ...
                    <select type="time" name="time" class="mt-2 block w-full border-gray-300 focus:border-gray-500 focus:ring-0">
